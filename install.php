...
<?php } else { ?>
    <div id="install-content">
        <div id="install-header">
            ...
            <h5><label style="color:#ff0000">On linux based machines make sure your user have write access to create the configuration file.</label> The following informations can be changed later in the newly created file "engine/global_config.php"</h5>
